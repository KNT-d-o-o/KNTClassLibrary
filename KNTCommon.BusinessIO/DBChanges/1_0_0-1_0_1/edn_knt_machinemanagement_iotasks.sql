...
CREATE TABLE `iotasks` (
  `IoTaskId` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `iotasks` VALUES (1,'DB Backup',1,1,5,NULL,'NextMonth;Day=1;Time=00:30','2025-03-01 00:30:00',100,'Not used yet'),(2,'DB Restore',2,2,3,NULL,'','2025-03-13 00:00:00',100,'Not used yet');
